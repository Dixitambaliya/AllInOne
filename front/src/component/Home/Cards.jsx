    ...
    return (
        <div>
            <form className='flex flex-col items-center mt-8 w-full px-4 lg:px-0'>
                ...
                {/* <button
                    type='submit'
                    className=' hover:bg-blue-400 mt-4 px-4 py-2 bg-gradient-to-r from-yellow-600 to-yellow-500 text-xl text-white font-semibold rounded-lg '
                    disabled
                >
                    Search
                </button> */}
                    ...
                    {filteredCards.length > 0 ? (
                        filteredCards.map((items, index) => (
                            ...
                            >
                                ...
                                <Link to={`/${items.route}`} className='border px-4 py-3 bg-blue-500 font-semibold text-white rounded-md lg:py-2 lg:rounded-lg hover:bg-blue-400'>
                                    Explore More
                                </Link>
                            </div>
                        ))
